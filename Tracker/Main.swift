...
class MainScreen: UITabBarController, UISearchBarDelegate {
...
extension MainScreen {
    ...
    private func setupTabbar() {
        ...
        trackerNavigationController.tabBarItem.title = "Трекеры"
        trackerNavigationController.tabBarItem.image = UIImage(named: "record.circle.fill")
        statisticNavigationController.tabBarItem.title = "Статистика"
        statisticNavigationController.tabBarItem.image = UIImage(named: "hare.fill")
        
        // Устанавливаем дочерние ViewController'ы в массив viewController'ов
        self.setViewControllers([trackerNavigationController, statisticNavigationController], animated: true)
